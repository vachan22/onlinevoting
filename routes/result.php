...
<body>
<div class="div5">
<form name="myform" id="myform" action=" result.php" method="POST" enctype="multipart/form-data">
           Select Position :
            <select name="pos">
		 <?php
...
<center>
    ...
    <script type="text/javascript">
      ...
      function drawStuff() {
        ...
        var options = {
          ...
          width: 1300,
          height:350,
          legend: { position: 'fixed' ,width:'800px'},
          chart: { title: 'Result',
                   subtitle: 'Votes' },
  ...
  <body>
    <div id="top_x_div" style="width: 600px; height: 400px;background-color:transparent;"></div>
  </body>
</html>
            </div>
            </center> 
